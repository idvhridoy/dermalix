...
export default function IngredientKnowledgeQuiz() {
  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-2xl">
      <h1 className="text-3xl font-bold mb-6 text-center">Ingredient Knowledge Quiz</h1>
        ...
        <div className="text-center">
          ...
          <p className="mb-6">
            {score === ingredientQuestions.length 
              ...
              : score >= ingredientQuestions.length / 2 
                ? "Good job! You know quite a bit about skincare ingredients." 
                : "Keep learning! There's always more to discover about skincare."}
          </p>
          <button 
            onClick={restartQuiz}
